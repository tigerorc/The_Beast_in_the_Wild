...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            textbutton _("{outlinecolor=#ebf1f5}{alpha=1}新开始{/alpha}{/outlinecolor}") action ShowMenu("selectChapters1")
        else:
            textbutton _("历史") action ShowMenu("history")
            textbutton _("保存") action ShowMenu("save")
