...
define gui.idle_color = '#d0d6d9'

#小的颜色用于小的文本，需要更亮/更暗才能达到同样的效果
define gui.idle_small_color = '#d0d6d9'

#当按钮和滑条被悬停时使用的颜色
define gui.hover_color = '#ffffff'

#当文本按钮被选中但非焦点时使用的颜色当一个按钮为当前屏幕或设置选项值时，会处于选中状态
define gui.selected_color = '#ffffff'

#当文本按钮无法被选择时使用的颜色
define gui.insensitive_color = '#8888887f'

#滑条未填充的部分使用的颜色这些颜色不直接使用，但在重新生成条形图像文件时使用
...
#对话字体
define gui.text_font = "方正清刻本悦宋简体.ttf"
#界面字体
define gui.interface_text_font = "方正清刻本悦宋简体.ttf"
#人物名 字体
define gui.name_text_font = "方正清刻本悦宋简体.ttf"
#对话文本字体大小
...
#文本框在屏幕上的垂直位置0.0 是顶部，0.5 是居中，1.0 是底部
define gui.textbox_yalign = 1.0
#叙述角色名字相对于文本框的位置可以是从左侧或顶部起的整数像素，或设为 0.5 来
#居中
define gui.name_xpos = 360
define gui.name_ypos = 0
#角色名字的水平对齐方式0.0 为左侧对齐，0.5 为居中显示，而 1.0 为右侧对齐
...
#对话相对于文本框的位置可以是相对于文本框从左侧或顶部起的整数像素，或设为
#0.5 来居中
define gui.dialogue_xpos = 402
define gui.dialogue_ypos = 75
#对话文本的最大宽度，以像素为单位
define gui.dialogue_width = 1116
#对话文本的水平对齐方式0.0 为左侧对齐，0.5 为居中显示，而 1.0 为右侧对齐
define gui.dialogue_text_xalign = 0.0
#按钮 #####################################
#
#这些变量以及 gui/button 中的图像文件控制着按钮显示方式
#按钮的宽度和高度像素数如果为 None，则 Ren'Py 将计算大小
define gui.button_width = None
define gui.button_height = None
#按钮两侧的边框，按左、上、右、下的顺序排列
define gui.button_borders = Borders(6, 6, 6, 6)
#若为 True，则背景图像将平铺若为 False，则背景图像将线性缩放
...
#这些变量覆盖了不同类型按钮的设置关于可用的按钮种类以及每种按钮的用途，请参
#阅 gui 文档
#
#这些定制由默认界面使用：
...
#您还可以通过添加正确命名的变量来添加自己的定制例如，您可以将以下几行取消注
#释来设置导航按钮的宽度
...
#存档按钮 ####################################
#
#存档按钮是一种特殊的按钮它包含一个缩略图和描述该存档内容的文本存档使用
...
#导航按钮左侧相对于屏幕左侧的位置
define gui.navigation_xpos = 1200
define gui.navigation_ypos = 750
#快进指示器的垂直位置
define gui.skip_ypos = 15
#通知界面的垂直位置
define gui.notify_ypos = 68
#菜单选项之间的间距
define gui.choice_spacing = 45
#导航按钮之间的距离
...
#
#默认的 GUI 仅使用滑块和垂直滚动条所有其他栏仅在创建者编写的屏幕中使用
#水平条，滚动条和滑块的高度垂直条，滚动条和滑块的宽度
define gui.bar_size = 38
define gui.scrollbar_size = 18
define gui.slider_size = 38
#若为 True，则条的底图平铺若为 False，则条的底图线性缩放
...
#Ren'Py 所显示的 NVL 模式条目的最大数量当要显示的条目多于此数量时，最旧的条
#目将被删除
define gui.nvl_list_length = 6
#NVL 模式条目的高度将此设置为 None 可使条目动态调整高度
...
#本地化 #####################################
#该变量控制允许在何时换行默认值适用于大多数语言可用的值请参见 https://
